...
{
    public partial class FormBezierCuadratico : Form
    {
        private static FormBezierCuadratico instancia = null;
        private CBezierCuadratica curva;
        private Timer timer;
        private float t = 0;
        private bool arrastrando = false;
        private int puntoArrastrado = -1;

        public static FormBezierCuadratico Instancia
        {
            get
            {
                if (instancia == null || instancia.IsDisposed)
                    instancia = new FormBezierCuadratico();
                return instancia;
            }
        }

        public FormBezierCuadratico()
        {
            InitializeComponent();
            Inicializar();
        }
        ...
        {
            this.Text = "Curvas de Bézier Cuadráticas";
        ...
        private void CrearCurvaInicial()
        {
            ...
            curva = new CBezierCuadratica(p0, p1, p2);
        }
        ...
        private void FormBezierCuadratico_Load(object sender, EventArgs e)
        {
